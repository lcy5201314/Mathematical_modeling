...
function [xrecon, mrecon, srecon]=NBP_opt2(A,x,y,sigma_Z,max_iter,...
    dispind,epsilon,pdf_prior,noise_prior,xticks,i,j,s)

n=length(x);      
m=length(y);
M2N = sparse_cell(i,j,s);
N2M = sparse_cell(i,j,s);
